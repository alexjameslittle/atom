...
Atom is a Rust-first mobile application framework. App logic, runtime support crates, and modules
...
renderer — navigation, persistence, and analytics are libraries, not kernel features.
