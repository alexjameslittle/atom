...
Rust-backed module, two native-only modules, two first-party runtime support crates outside
...
`apps/hello_atom` consumes the Rust-backed module, runtime support crates, and the demo surface
module as normal Bazel dependencies:
