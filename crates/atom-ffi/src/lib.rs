...
mod tests {
    ...
    use super::{
        AtomError, AtomErrorCode, AtomExportInput, AtomExportOutput, AtomImportInput,
        AtomImportOutput, AtomOwnedBuffer, AtomSlice, clear_buffer, require_owned_buffer_slot,
